...
enum {
	TG_API_PARSE_TYPE_PLAIN,
	TG_API_PARSE_TYPE_FORMAT,
};


enum {
	TG_API_VALUE_TYPE_TEXT,
	TG_API_VALUE_TYPE_URL,
	TG_API_VALUE_TYPE_FILE,
};
...
enum {
	...
	TG_API_ERR_TEXT_TYPE_INVALID    = -2,
	TG_API_ERR_VALUE_TYPE_INVALID   = -3,
	TG_API_ERR_VALUE_INVALID        = -4,
	TG_API_ERR_CAPTION_INVALID      = -5,
	TG_API_ERR_CHAT_ID_INVALID      = -6,
	TG_API_ERR_USER_ID_INVALID      = -7,
	TG_API_ERR_MSG_ID_INVALID       = -8,
	TG_API_ERR_REPLY_MSG_ID_INVALID = -9,
	TG_API_ERR_CALLBACK_ID_INVALID  = -10,
	TG_API_ERR_HAS_NO_TYPE          = -11,
